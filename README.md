...
Here is my python source code for AirGesture - Play games without using keyboard. This project is an application of hand detection model in Tensorflow. With my code, you could play many games on PC without using keyboard. Till date you can play the following games 
